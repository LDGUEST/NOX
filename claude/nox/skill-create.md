...
# disable-model-invocation: true   ← for dangerous ops (deploy, iterate --unattended)
...
- **Missing `disable-model-invocation`** — Dangerous skills (deploy, iterate) must have this set to prevent accidental auto-triggering from natural language
