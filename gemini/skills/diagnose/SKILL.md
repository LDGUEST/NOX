---
name: diagnose
description: Cross-machine system health check and status report
---
...
Present results as a clean status table. Flag anything that is down, degraded, or unexpected. Do NOT attempt to fix anything — diagnosis only.
