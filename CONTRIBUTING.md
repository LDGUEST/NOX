...
| Category | Skills |
|----------|--------|
| Pipeline & Orchestration | full-phase, quick-phase, iterate |
| Code Quality | review, tdd, refactor, commit, uxtest |
| Security & Reliability | security, audit, perf |
| Architecture & Design | architect, brainstorm, prompt, skill-create |
| DevOps & Deploy | cicd, deploy, migrate, changelog |
| Multi-Agent Coordination | syncagents, handoff |
| Context Engineering | armor, context-engineer |
| Diagnostics | diagnose, questions |
| Meta | help-forge, update, start, guardrails |
| Registry (extended) | api, schema, landing, doc, swot, monitorlive, explain, env |
